        ...
        public static void Main() {
            ModAPI.Register(
                new Modification() {
                    ...
                    NameOverride = "SIG Sauer MCX Patrol",
                    NameToOrderByOverride = "A",
                    DescriptionOverride = "The SIG Sauer MCX Patrol, or as it's called in MW19, the M13.",
                    ...
                    AfterSpawn = (Instance) =>
                    {
                        ...
                        BarrelSprite.sprite = ModAPI.LoadSprite("textures/mcxpat_barrel.png", 22f);
                        ...
                        Slide.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("textures/mcxpat_bolt_transparent.png", 22f);
                        ...
                        SlideSprite.sprite = ModAPI.LoadSprite("textures/mcxpat_bolt.png", 22f);
                        ...
                        // Gun's Collider
                        Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("textures/mcxpat_collider.png", 22f);
                        ...
                        // Main Body Rendering
                        Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("textures/mcxpat_body.png", 22f);
                        ...
                        firearm.barrelPosition = new Vector3(0.752f, 0.0865f, 0.0f);
                        ...
                        firearm.ShotSounds = new AudioClip[] {
                            ModAPI.LoadSound("sounds/mcxpat_01.wav"),
                            ModAPI.LoadSound("sounds/mcxpat_02.wav"),
                            ModAPI.LoadSound("sounds/mcxpat_03.wav")
                        };
                        ...
                        firearm.casingPosition = new Vector3(-0.1f, 0.1f, 0.0f);
                    }
                }
            );
        }
